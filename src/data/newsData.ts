...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    content: `
      <p>スプリントジャパン株式会社のコーポレートサイトを独立したドメイン（https://ssprintjapan.net/）で新たに立ち上げました。会社の方針やニュース、製品情報をより速く・分かりやすくお伝えしていきます。</p>
      
      <h2>リニューアルのポイント</h2>
      <p>新しいウェブサイトは、お客さまや一般訪問者がスプリントジャパンの方向性や製品をより直感的に理解できるよう、以下の点を重視して設計しています。</p>
