...
export const newsData: NewsItem[] = [
  {
    ...
    content: `
      <p>スプリントジャパン株式会社は、2025年10月17日、組織の理念やMTP（Massive Transformative Purpose）を、AIの力を活用して効率的に言語化するアプリケーション「TransformX」をリリースしました。</p>
      ...
      <p>「TransformX」は、このメソッドやナレッジをベースに、専用に学習させたAIを利用することで、組織の目指す方向性を、ステークホルダー全員が理解しやすい言葉で素早く正しく言語化することができます。</p>
      ...
      <h2>期待される効果</h2>
      <p>「TransformX」を利用することで、会社だけでなく、プロジェクト、部門、研究チームなど組織全般の理念、考え方、方針、コンセプトを明確に言語化でき、これにかかる時間を大幅に短縮できます。また、より明確で共感を呼ぶメッセージをステップバイステップで簡単に作成できます。</p>
