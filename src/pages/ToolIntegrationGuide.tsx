...
const ToolIntegrationGuide = () => {
  useEffect(() => {
    ...
    canonical.href = `${window.location.origin}/insights/tool-integration-guide/`;
  }, []);

  return (
    <SjShell>
      <InsightPaper id="tool-integration-guide" content={content} abstract="Claude Code・Slack・GitHub 等を統合し、1-3 人のチームが AI エージェント群と協働するための実装アーキテクチャ。" />
    </SjShell>
  );
};
